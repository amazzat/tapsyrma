...
export function BoardItem({ board }) {
  ...
  return (
    <div className="w-64 bg-black bg-opacity-50">
      <h5
        onClick={() => alert()}
        className="text-bold w-full p-5 text-2xl text-white"
      >
        {board.board_name}
      </h5>
      ...
      <div className="mt-3">
        <button
          style={{ display: inputVisible && "none" }}
        ...
        <div style={{ display: !inputVisible && "none" }}>
          <form className="flex flex-col" onSubmit={handleSubmitCreateTask}>
            <input
